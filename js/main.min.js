window.onunload = function () {
    ...
    function s() {
        ...
        this.config = function (t) {
            ...
            for (var n = 0, o = t.length; o > n; n++) {
                item = t[n];
                var s = '<li class="case-item"><h3 class="subheadline">' + item.title + "</h3></li>",
                    a = '<li class="slide" style="background: url(' + item.image + ') no-repeat; background-size:cover;"></li>';
                e += s, i += a
            }
            $(".case-illustration-container").append(i), $(".case-tabs").append(e), this.init()
        }, this.init = function () {
            this.initNum = 0, this.allSlides = $(".case-illustration-container > li.slide"), this.caseItems = $(".case-item"), this.galleryLength = this.allSlides.length, this.speed = .4, $(this.caseItems[0]).addClass("active"), $(".case-copy").text(this.data[this.initNum].copy);
            for (var t = 0, e = this.galleryLength; e > t; t++)
                if (0 != t) {
                    var i = $(this.allSlides[t]);
                    TweenMax.to(i, 0, {
                        zIndex: -1,
                        opacity: 0
                    })
            ...
            t && (t = !1, this.initNum === this.galleryLength - 1 ? (TweenMax.to($(this.allSlides[this.initNum]), this.speed, {
                zIndex: -1,
                opacity: 0
            }), TweenMax.to($(this.allSlides[this.initNum - 1]), this.speed, {
                zIndex: 12,
                opacity: 1,
                delay: this.speed,
                onComplete: this.unlock(),
                onCompleteScope: this
            })) : (TweenMax.to($(this.allSlides[this.initNum]), this.speed, {
                zIndex: -1,
                opacity: 0
            }), 0 === this.initNum ? TweenMax.to($(this.allSlides[this.galleryLength - 1]), this.speed, {
                zIndex: 12,
                opacity: 1,
                delay: this.speed,
                onComplete: this.unlock(),
                ...
                onComplete: this.unlock(),
                onCompleteScope: this
            })), 0 === this.initNum ? this.initNum = this.galleryLength - 1 : this.initNum--, this.updateBullets(this.initNum), this.changeCopy(this.initNum))
        }, this.next = function () {
            t && (t = !1, this.initNum === this.galleryLength - 1 ? (TweenMax.to($(this.allSlides[this.initNum]), this.speed, {
                zIndex: -1,
                opacity: 0
            }), TweenMax.to($(this.allSlides[0]), this.speed, {
                zIndex: 12,
                opacity: 1,
                delay: this.speed,
                onComplete: this.unlock(),
                ...
                onComplete: this.unlock(),
                onCompleteScope: this
            })), this.initNum < this.galleryLength - 1 ? this.initNum++ : this.initNum = 0, this.updateBullets(this.initNum), this.changeCopy(this.initNum))
        }, this.unlock = function () {
            setTimeout(function () {
                t = !0
            }, 400)
        }, this.changeCopy = function (t) {
            var e = $(".case-copy"),
                i = this.data;
            TweenMax.to(e, .3, {
                opacity: 0,
        ...
        }, this.updateBullets = function (t) {
            $(this.caseItems).removeClass("active"), $(this.caseItems[t]).addClass("active")
        }, this.jumpTo = function (e) {
            t && (t = !1, this.updateBullets(e), this.changeCopy(e), TweenMax.to($(this.allSlides[this.initNum]), this.speed, {
                zIndex: -1,
                opacity: 0
            }), TweenMax.to($(this.allSlides[e]), this.speed, {
                zIndex: 12,
                opacity: 1,
                delay: this.speed,
                onComplete: this.unlock(),
    ...
    function a() {
        var t, e = "../js/usecases.json",
            i = new XMLHttpRequest;
        i.open("GET", e, !0), i.onload = function (e) {
            4 === i.readyState && (200 === i.status ? (t = JSON.parse(i.responseText), k = new s, k.config(t)) : console.error(i.statusText))
    ...
    function p(t) {
        ...
        }, this.ratio = t.ratio || window.devicePixelRatio || 1, this.width = t.width || window.innerWidth || 1280, this.width_2 = this.width / 2, this.width_4 = this.width / 4, this.height = t.height || window.innerHeight || 720, this.height_2 = this.height / 2, this.height_3 = this.height / 3, this.MAX = this.height_2 - 4, this.amplitude = t.amplitude || 0, this.speed = t.speed || .02, this.frequency = t.frequency || 2, this.angle = 0, this.circleProgress = 0, this.radius = (t.ratio || 1) * this.height * .4, this.canvas = document.getElementById("canvas"), this.canvas.width = this.width, this.canvas.height = this.height, this.container = t.container || document.body, this.container.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.backingStoreRatio = this.ctx.webkitBackingStorePixelRatio || this.ctx.mozBackingStorePixelRatio || this.ctx.msBackingStorePixelRatio || this.ctx.oBackingStorePixelRatio || this.ctx.backingStorePixelRatio || 1, this.gradient = this.ctx.createLinearGradient(0, 0, 0, 2 * this.radius), this.gradient.addColorStop(0, "#4aa3da"), this.gradient.addColorStop(1, "#ce3745"), this.squareSide = Math.sqrt(Math.pow(2 * this.radius, 2) / 2)
    }
    var u, d = $("body"),
        ...
        g = $(".lower-type"),
        w = $(".upper-type"),
        f = (parseInt($(".lower-type").css("font-size")), ["Signage Host", "Aboutus", "Features", "Products", "Contact"]),
        x = (f.length, !1),
        b = 0,
        v = 500;
    ...
    var k;
    if (a(), $('a[href*="#"]:not([href="#"])').click(function () {
        ...
        new Waypoint({
            ...
            handler: function (t) {
                "down" === t && ($("body").addClass("menu-light"), T.backgroundChanger("#252525"), T.sidebar(1, .1), T.titleChanger(1), T.password(), S.stop())
            },
            offset: "80%"
        }), new Waypoint({
            element: document.getElementById("problem"),
            handler: function (t) {
                "up" === t && ($("body").addClass("menu-light"), T.passwordReset(), T.backgroundChanger("#252525"), T.sidebar(1, -.1), T.titleChanger(1))
            },
            offset: function () {
    ...
    var T = {
        ...
        password: function () {
            ...
            return t.to("#intro", .3, {
                ...
                opacity: 1
            }, "sync").to($("#problem .circle"), .6, {
                strokeDashoffset: 0
            }, "-=0.3").to("#problem .section-num-label", .3, {
                opacity: 1
            }, "-=0.2").to($("#problem .headline"), .6, {
                opacity: 1,
                y: 0
            }, "-=0.2").staggerTo($("#problem .js-fadeIn"), .6, {
                opacity: 1,
                y: 0
            }, .1, "-=0.3")
        },
        ...
        sonicUnlock: function () {
            ...
            return t.staggerFromTo(".wave", 1.2, {
                ...
                opacity: 1
            }, "-=0.3").to(".s_server .circle-big", .3, {
                strokeDashoffset: 0
            }, "-=0.8").to(".s_server .icon-unlocked", .3, {
                opacity: 1
            }, "-=0.3")
        },
        sonicLock: function () {
            ...
            return t.to(".s_server-light", .3, {
                ...
                opacity: 0
            }, "-=0.2").to(".s_server .icon-unlocked", .3, {
                opacity: 0
            }, "-=0.2").to(".s_server .icon-signagehost", .3, {
                opacity: 0,
                scaleX: .8,
                scaleY: .8
            }, "-= 1").to(".s_server-light", .3, {
                ...
                scaleX: 1,
                scaleY: 1
            }).to(".s_server .circle-big", .3, {
                strokeDashoffset: 302
            }, "-=0.3").to(".s_server .icon-lock", .3, {
                opacity: 1,
                scaleX: 1,
                scaleY: 1
            })
        ...
        solutionIn: function () {
            ...
            return t.to("#problem", .2, {
                ...
                opacity: 1,
                y: 0
            }, "-=0.3").staggerTo("#solution .js-fadeIn", 1.2, {
                opacity: 1,
                y: 0
            }, .2, "-=0.3")
        },
        solutionIllustration: function () {
            ...
            t.to(".s_phone", 2, {
                ...
                ease: Expo.easeOut
            }, "-=1.6").to(".s_phone .circle-container ", .6, {
                opacity: 1
            }, "-=1.4")
        },
        usecasesIn: function () {
            ...
            i.to("#usecases .case-illustration-container.js-fadeIn-center", .6, {
                opacity: 1,
                y: e,
                x: t
            }, "sync").to($("#usecases .circle"), .6, {
                strokeDashoffset: 0
                ...
                opacity: 1,
                y: 0
            }, "-=0.3").staggerTo("#usecases .js-fadeIn", .8, {
                opacity: 1,
                y: 0
            }, .1, "-=0.3")
        },
        partnerIn: function () {
            var t = new TimelineMax;
            return t.to("#partner .mail-illustration.js-fadeIn", .6, {
                opacity: 1,
                y: "0"
            }).to($("#partner .circle"), .6, {
                strokeDashoffset: 0
                ...
                opacity: 1
            }, "-=0.3").staggerTo("#partner .js-fadeIn", .8, {
                opacity: 1,
                y: 0
            }, .1, "-=0.3")
        }
